...
{
    public partial class cultureweb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Meterial = table.Column<string>(type: "longtext", nullable: false),
                    Description = table.Column<string>(type: "longtext", nullable: true),
                    Name_kh = table.Column<string>(type: "longtext", nullable: false),
                    Meterial_kh = table.Column<string>(type: "longtext", nullable: false),
                    Description_kh = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    PurchaseNo = table.Column<string>(type: "longtext", nullable: false),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title_kh = table.Column<string>(type: "longtext", nullable: false),
                    Image = table.Column<string>(type: "longtext", nullable: true),
                    SubCategoryId = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "longtext", nullable: false),
                    Description_kh = table.Column<string>(type: "longtext", nullable: false),
                    BlogTitle = table.Column<string>(type: "longtext", nullable: true),
                    BlogDesc = table.Column<string>(type: "longtext", nullable: true),
                    BlogTitle_kh = table.Column<string>(type: "longtext", nullable: true),
                    BlogDesc_kh = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductColor_kh = table.Column<string>(type: "longtext", nullable: false),
